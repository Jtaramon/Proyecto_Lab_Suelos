...
function Cuarta() {
    ...
    document.getElementById('recibeformulaEpMrps1').innerHTML = "(Mr*d0 corregido)/P = ("+1000+" * "+document.getElementById("moduloResRetro").value+" * "+ document.getElementById("totalD0Cor").value+") / "+document.getElementById("carga").value;
    document.getElementById('recibeformulaEpMrps2').innerHTML = "(Mr*d0 corregido)/P = "+y.toFixed(3)+" / "+document.getElementById("carga").value;
    document.getElementById('recibeformulaEpMrps3').innerHTML = "(Mr*d0 corregido)/P = "+y1.toFixed(3);
    document.getElementById('recibeformulaEpMrps4').innerHTML = "Una vez obtenido el valor (Mr*d0 corregido)/P se ubica el resultado en las ordenadas, mientras que en el eje de las abscisas se ubica el espesor efectivo del pavimento; ingresamos estas coordenadas en el ábaco que se muestra en la Figura 2, cuya intersección entre dichos valores con una de las curvas de la relación Ep/Mr tiene un valor de  "+
    document.getElementById('totalEpMr').value+"; sin embargo, dicha relación Ep/Mr se la puede calcular matemáticamente como se indica a continuación, para ello se debe despejar el término Ep/Mr de la expresión indicada.";
