...
//*********************HABILITAR BOTONES***************************
function Habilitar() {
	var valor = document.getElementById("btnEnable").value;
	document.getElementById("moduloResRetro").value ="";

	if ( document.getElementById("btnEnable").value == "Deshabilitar FWD") {
		
		document.getElementById("btnEnable").innerHTML = "Ingresar FWD";
		document.getElementById("btnEnable").value = "Ingresar FWD";
		document.getElementById("bulbo").style.display = "none";
		document.getElementById('moduloResRetro').removeAttribute("disabled");

	}else if (document.getElementById("btnEnable").value == "Ingresar FWD") {

		document.getElementById("btnEnable").innerHTML = "Deshabilitar FWD";
		document.getElementById("btnEnable").value = "Deshabilitar FWD";
		document.getElementById("bulbo").style.display = "inline";
		document.getElementById('moduloResRetro').setAttribute("disabled", "");
	}
}
...
function CalcularFactorCondicion(){
	...
	if (document.getElementById("cmbBases").value == 1) {
		...
		if (check.checked ==true && check2.checked == false ) {
			...
			{
				sweetAlert("Campos vacios", "Por favor, complete todos los espacios necesarios", "error");
				//Limpia Body FC
...
function CalcularNDT(){
	if (
		document.getElementById("coefEstrucCarpAsNDT").value == "" 
		) 
	{
		sweetAlert("Campos vacíos", "Por favor, complete todos los espacios necesarios", "error");
...
function AnclaBase(){
	...
	var base = document.getElementById("MenuBase").getAttribute("aria-expanded");
	var subBase = document.getElementById("MenuSub").getAttribute("aria-expanded");
	var matMej = document.getElementById("MenuMatMej").getAttribute("aria-expanded");
...
function PresionPlato(){
	...
	//Reporte
	document.getElementById('recibeformulaPres').innerHTML = "p = "+carga+" / (3.14 * "+radio+" ^ 2)";
...
function D0Corregido(){
	...
	document.getElementById("recibeformulad0Corr").innerHTML= "d0 corregido = "+defleCentroCarga+" * "+factor;
	document.getElementById("recibeformulad0Corr1").innerHTML= "d0 corregido = "+D0Corregido+" in";
	document.getElementById("recibetextFig").innerHTML= "Apreciando en la Figura 1 se puede verificar que el valor del factor corrección es "+factor+". Una vez obtenido el factor de corrección, se procede a corregir la deflexión al centro de carga con la siguiente ecuación:";
}
...
function EpMr() {
	...
	for (i = 0; i < 100; i += 0.01) {
		...
		if (0 <= EpMr && EpMr <= 0.001) {
			total=i;
			document.getElementById("recibeD0").innerHTML = "d0 = "+cor; 
			document.getElementById("recibeA").innerHTML = "A = 1.5 * "+p+" * "+a;
			document.getElementById("recibeB").innerHTML = "B = {[1-(1/(1+("+D+"/"+a+")^2)^1/2)]}"
			document.getElementById("recibeC").innerHTML = "C = {"+mr+"*[1+(("+D+"/"+a+")*((Ep/Mr)^1/3))^2]^1/2}";
			document.getElementById("recibeD").innerHTML = "D = Ep/Mr * "+mr;
...
function CalculoSN() {
	...
	for (i = 1; i < 10; i += 0.0001) {
		...
		if (0 <= sn && sn <=0.0001) {
			total = i;
			document.getElementById("recibeW18").innerHTML ="Nro. ESAL´S final = "+w18;
			document.getElementById("recibeWA").innerHTML = "A = [("+zr+" * "+so+") + (9.36 * Log10(SNfuturo + 1)) - (0.2)]";
			document.getElementById("recibeWB").innerHTML = "B = {Log10[("+psi+") / (4.2 - 1.5)]}";
			document.getElementById("recibeWC").innerHTML = "C = {0.4 + [1094 / ((SNfuturo + 1)^ 5.19)]} ";
			document.getElementById("recibeWD").innerHTML = "D = {[2.32 * Log10("+mre+")]- 8.07 }";
			document.getElementById("recibeSN").innerHTML = "Para resolver esta ecuación se debe despejar la variable SNfuturo o calcular su valor por tanteos. Cualquiera de las dos formas obtiene el mismo valor de SNfuturo = "+total.toFixed(3)+". Ahora bien, si no se puede resolver la ecuación matemáticamente se puede utilizar el ábaco con el cual se llegan a resultados similares, tal como se muestra en la Figura 3.";

			document.getElementById("recibeW181").innerHTML ="Nro. ESAL´S final = "+w18;
			document.getElementById("recibeWA1").innerHTML = "A = [("+zr+" * "+so+") + (9.36 * Log10(SNfuturo + 1)) - (0.2)]";
			document.getElementById("recibeWB1").innerHTML = "B = {Log10[("+psi+") / (4.2 - 1.5)]}";
			document.getElementById("recibeWC1").innerHTML = "C = {0.4 + [1094 / ((SNfuturo + 1)^ 5.19)]} ";
			document.getElementById("recibeWD1").innerHTML = "D = {[2.32 * Log10("+mre+")]- 8.07 }";
			document.getElementById("recibeSN1").innerHTML = "Para resolver esta ecuación se debe despejar la variable SNfuturo o calcular su valor por tanteos. Cualquiera de las dos formas obtiene el mismo valor de SNfuturo = "+total.toFixed(3)+". Ahora bien, si no se puede resolver la ecuación matemáticamente se puede utilizar el ábaco con el cual se llegan a resultados similares, tal como se muestra en la Figura 6.";

			document.getElementById("recibeW182").innerHTML ="Nro. ESAL´S final = "+w18;
			document.getElementById("recibeWA2").innerHTML = "A = [("+zr+" * "+so+") + (9.36 * Log10(SNfuturo + 1)) - (0.2)]";
			document.getElementById("recibeWB2").innerHTML = "B = {Log10[("+psi+") / (4.2 - 1.5)]}";
			document.getElementById("recibeWC2").innerHTML = "C = {0.4 + [1094 / ((SNfuturo + 1)^ 5.19)]} ";
			document.getElementById("recibeWD2").innerHTML = "D = {[2.32 * Log10("+mre+")]- 8.07 }";
			document.getElementById("recibeSN2").innerHTML = "Para resolver esta ecuación se debe despejar la variable SNfuturo o calcular su valor por tanteos. Cualquiera de las dos formas obtiene el mismo valor de SNfuturo = "+total.toFixed(3)+". Ahora bien, si no se puede resolver la ecuación matemáticamente se puede utilizar el ábaco con el cual se llegan a resultados similares, tal como se muestra en la Figura 8.";
...
function EsalsRemanente(a) {
	...
	document.getElementById("recibeWA15").innerHTML = "A = [(0 * "+so+") + (9.36 * Log10("+sn+" + 1)) - (0.2)]";
	document.getElementById("recibeWB15").innerHTML = "B = {Log10[(2.7) / (4.2 - 1.5)]}";
	document.getElementById("recibeWC15").innerHTML = "C = {0.4 + [1094 / (("+sn+" + 1)^ 5.19)]} ";
	document.getElementById("recibeWD15").innerHTML = "D = {[2.32 * Log10("+document.getElementById("totalModResEfectivo").value+")]- 8.07 }";
	document.getElementById("recibeW15").innerHTML = "Nro ESAL´S 1.5 = 10^[A+(B/C)+D]";
	document.getElementById("recibeTotalW15").innerHTML = "Nro ESAL´S 1.5= "+w18Remanente.toFixed(0);
...
function ModuloResilienteEfectivo(){
	...
	// REPORTE METODO NDT
	document.getElementById("recibeModResEfectivo").innerHTML = "Mre = ("+resretro+"*"+D+")";
	document.getElementById("recibeTotalModResEfectivo").innerHTML = "Mre = "+total.toFixed(3)+" psi";
	document.getElementById("recibeTextModRes").innerHTML = "Con el módulo resiliente efectivo de la subrasante de "+total.toFixed(3)+" psi, se procede a calcular el SNfuturo, para ello se necesitan los siguientes datos";
	//REPORTE METODO FACTOR
	document.getElementById("recibeModResEfectivo1").innerHTML = "Mre = ("+resretro+"*"+D+")";
	document.getElementById("recibeTotalModResEfectivo1").innerHTML = "Mre = "+total.toFixed(3)+" psi";
	document.getElementById("recibeTextModRes1").innerHTML = "Con el módulo resiliente efectivo de la subrasante de "+total.toFixed(3)+" psi, se procede a calcular el SNfuturo, para ello se necesitan los siguientes datos";

	//REPORTE METODO VIDA
	document.getElementById("recibeModResEfectivo2").innerHTML = "Mre = ("+resretro+"*"+D+")";
	document.getElementById("recibeTotalModResEfectivo2").innerHTML = "Mre = "+total.toFixed(3)+" psi";
	document.getElementById("recibeTextModRes2").innerHTML = "Con el módulo resiliente efectivo de la subrasante de "+total.toFixed(3)+" psi, se procede a calcular el SNfuturo, para ello se necesitan los siguientes datos";
...
function ModuloEfectivoPav(){
	...
	//reporte
	document.getElementById('recibedescriEpMr2').innerHTML = "Finalizando, con la ecuación mostrada enseguida se obtiene el valor Ep = "+tot.toFixed(3)+" psi. Siendo “Mr” el módulo resiliente retrocalculado."
	
	document.getElementById("recibeEp").innerHTML = "Ep = "+Res+"*"+totalEp;
...
function DeflexionesDistancias(){
	...
	function SnefNDT(){
		...
		document.getElementById("recibeSnefNDT").innerHTML = "SNef = 0.045*"+total2+"*("+ep+")^1/3";
		document.getElementById("recibeTotalSnefNDT").innerHTML = "SNef = "+total1.toFixed(3);
		document.getElementById('recibedescrsnefNDT1').innerHTML ="En la Figura 4 se ingresa con el valor del espesor efectivo del pavimento previo ("+total2+" in) y se traza una vertical hasta llegar al valor Ep calculado anteriormente ("+ep+" psi). A partir de este punto se traza una horizontal hasta cortar con el eje de SNef, que en este caso es de "+ total1.toFixed(3)+"."; 
		document.getElementById('recibedescrsnefNDT2').innerHTML ="Una vez obtenido el valor de SNef, el SN futuro y el coeficiente estructural de la nueva carpeta, con un valor de a = "+ document.getElementById('coefEstrucCarpAsNDT').value+" (ver Figura 5) se calcula el espesor de sobrecarpeta mediante la siguiente ecuación:"; 
	}
...
function Sn0VidaRemanente(){
	...
	//IMPRIMIR
		...
		if (cmbselecSub ==''&&coefMejora1=='') {
			//Vida REma
			document.getElementById("recibeSnefVida").innerHTML = "SN0 = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SN0 = "+Resultotal.toFixed(3);
		}else if (cmbselecSub!=''&&coefMejora1=='') {
			//VIDA REMA
			document.getElementById("recibeSnefVida").innerHTML = "SN0 = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+subbase+"*"+coefsub1+"*"+coefDrena2+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SN0 = "+Resultotal.toFixed(3);
			...
			//VIDA REMA
			document.getElementById("recibeSnefVida").innerHTML = "SN0 = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+EspeMateria+"*"+coefMejora1+"*"+coefDrena3+")";
			document.getElementById("recibeTotalSnefVida").innerHTML = "SN0 = "+Resultotal.toFixed(3);
		}
...
function cargarEjemplo(){
	...
	document.getElementById("moduloResRetro").value=16901;
...
function VariablesDeEntrada(){
	...
	//PONER EN 0 FACTOR CONDICION
	document.getElementById('espFinalFactor').value = '';

	//PONER EN 0 VIDA REMANENTE
	document.getElementById('espFinalVida').value = '';
...
function printDiv(){
	  ...
	  document.getElementById("recibetemp").innerHTML = "Temperatura (T): "+document.getElementById("temperatura").value+" °F";
	  ...
	  document.getElementById("recibedescnesal").innerHTML = "Con este valor y el Nro. ESALS´s Inicial o acumulados en el carril de diseño ("+document.getElementById('nroInicial').value+") se calcula el porcentaje de vida remanente (%RL) con la siguiente fórmula:";
	  	...
	  	document.getElementById("recibedescriPres").innerHTML = "Seguido, se obtiene el factor de corrección para corregir la deflexión al centro de carga por efectos de temperatura, esto ingresando en la Figura 1 en el eje “x” la temperatura de la mezcla de asfalto (°F) y cortando en el eje “y” con la línea correspondiente al espesor de la carpeta asfáltica, que en este caso es: "
	  ...
	  document.getElementById("recibeGraficaModElas2").src = dataURL19;
		...
		document.getElementById("recibecalcsnVida").innerHTML = "Cálculo del SN estructural futuro: "+document.getElementById("totalSN").value;
	  	...
	  	document.getElementById("recibecapertaAsVida").innerHTML = "Carpeta asfáltica: a= "+document.getElementById("coefEstrucCarpAs1").value;

	  	//METODO FACTOR - MODAL
	  	document.getElementById("recibecapertaAsFact").innerHTML = "Carpeta asfáltica: ec = "+document.getElementById('espesorCarpAs').value+" ; a = "+document.getElementById("coefEstrucCarpAs").value;
	  	...
	  	if (fre=="") {
	  		...
	  		var total = EspConcreAs-fre;
				...
				if (cmbselecSub ==''&&coefMejora1=='') {
					document.getElementById("recibeSnefFactor").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")";
					document.getElementById("recibeTotalSnefFactor").innerHTML = "SNef = "+Resultotal.toFixed(3);
				}else if (cmbselecSub!=''&&coefMejora1=='') {
					document.getElementById("recibeSnefFactor").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+subbase+"*"+coefsub1+"*"+coefDrena2+")";
					document.getElementById("recibeTotalSnefFactor").innerHTML = "SNef = "+Resultotal.toFixed(3);

				}else if (cmbselecSub!=''&&coefMejora1!='') {
					document.getElementById("recibeSnefFactor").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+subbase+"*"+coefsub1+"*"+coefDrena2+")+("+EspeMateria+"*"+coefMejora1+"*"+coefDrena3+")";
					document.getElementById("recibeTotalSnefFactor").innerHTML = "SNef = "+Resultotal.toFixed(3);
				}else if (cmbselecSub==''&&coefMejora1!='') {
					document.getElementById("recibeSnefFactor").innerHTML = "SNef = ("+total+"*"+coef+")+("+EspBase+"*"+coefbas+"*"+coefDrena+")+("+EspeMateria+"*"+coefMejora1+"*"+coefDrena3+")";
					document.getElementById("recibeTotalSnefFactor").innerHTML = "SNef = "+Resultotal.toFixed(3);
				}
		...
		if (selecbase == 1) {
			document.getElementById("recibecoefBaseFact").innerHTML = "Base Granular: e1 = "+document.getElementById('espesorBase').value+" ; a1 = "+document.getElementById("coefBaseGra").value+" ; m1 = "+document.getElementById("coefDrenaBase").value;
			document.getElementById("recibecoefBaseVida").innerHTML = "Base Granular: e1 = "+document.getElementById('espesorBase').value+" ; a1 = "+document.getElementById("coefBaseGra1").value+" ; m1 = "+document.getElementById("coefDrenaBase").value;

		}else if (selecbase == 2) {
			
			document.getElementById("recibecoefBaseFact").innerHTML = "Base tratada con cemento: e1 = "+document.getElementById('espesorBase').value+" ; a1 = "+document.getElementById("coefBaseCem").value+" ; m1 = "+document.getElementById("coefDrenaBase").value;
			document.getElementById("recibecoefBaseVida").innerHTML = "Base tratada con cemento: e1 = "+document.getElementById('espesorBase').value+" ; a1 = "+document.getElementById("coefBaseCem1").value+" ; m1 = "+document.getElementById("coefDrenaBase").value;
		}
		// SUBBASE COMPARACION
		...
		if (espesorSubBase==""&&coefDrenaSubBase=="") {
			...
			document.getElementById("recibecoefSubbaseFact").innerHTML = 'SubBase: e2 = '+espesorSubBase+" ; a2= "+coefSubBase+'m2= '+coefDrenaSubBase;

			document.getElementById('tablaSubaseMetVida').style.display = 'inline';
			document.getElementById("recibecoefSubbaseVida").innerHTML = 'SubBase: e2 = '+espesorSubBase+" ; a2= "+coefSubBase1+'m2= '+coefDrenaSubBase;
		...
		if (espesorSubBase==""&&coefDrenaSubBase=="") {
			...
			document.getElementById("recibecoefmaterialFact").innerHTML = 'Material de mejoramiento: e3 = '+espesorMaterial+" ; a3= "+coefMaterial+' m3 = '+coefDrenaMaterial;

			document.getElementById('tablaMaterialMetVida').style.display = 'inline';
			document.getElementById("recibecoefmaterialVida").innerHTML = 'Material de mejoramiento: e3 = '+espesorMaterial+" ; a3= "+coefMaterial1+' m3 = '+coefDrenaMaterial;
		...
		document.getElementById('recibeDescripMet').innerHTML ="Una vez obtenido el valor de SNef, el SN futuro y el coeficiente estructural de la nueva carpeta, con un valor de a = "+ document.getElementById('coefEstrucCarpAsNDT').value+" (ver Figura 7) se calcula el espesor de sobrecarpeta mediante la siguiente ecuación:";
		document.getElementById('recibeDescripVidaR').innerHTML ="Una vez obtenido el valor de SNef, el SN futuro y el coeficiente estructural de la nueva carpeta, con un valor de a = "+ document.getElementById('coefEstrucCarpAsNDT').value+" (ver Figura 10) se calcula el espesor de sobrecarpeta mediante la siguiente ecuación:";
	  	document.getElementById('recibeDescripCF').innerHTML="Con este porcentaje y de la Figura 9 se obtiene el valor "+document.getElementById('totalCF').value+" (CF)";
	  	document.getElementById('recibeDescripCf2').innerHTML="En la Figura 9 se ingresa con el %RL ("+document.getElementById('RL').value+"). A partir de este se traza una vertical hasta intersecar la curva de vida remanente. En esta intersección se proyecta una línea horizontal y se lee el valor CF. Que en este caso es igual a "+document.getElementById("totalCF").value+".";
	  	document.getElementById('recibeDescriSnefVida1').innerHTML = "Con el número estructural del pavimento, si este fuera nuevamente construido("+document.getElementById('sn0Remanente').value+") y el valor CF calculado anteriormente se obtiene el numero estrúctural efectivo de acuerdo a la siguiente expresión: "	
...
function printDiv2(){
	...
	//DATOS DEL METODO NDT
	  ...
	  document.getElementById("recibeGrafRelacion").src = dataURL2;
		...
		document.getElementById("recibecalcsnVida").innerHTML = "Cálculo del SN estructural futuro: "+document.getElementById("totalSN").value;
	  	...
	  	//METODO FACTOR - MODAL
	  	document.getElementById("recibecapertaAsFact").innerHTML = "Carpeta asfáltica: a= "+document.getElementById("coefEstrucCarpAs").value;
	  	//VARIABLES PARA ECUACION FACTOR CONDUCION 
	  	var fre = document.getElementById("fres").value;
		...
		var selecbase = document.getElementById('cmbBases').value;
		if (selecbase == 1) {
			document.getElementById("recibecoefBaseFact").innerHTML = "Base Granular: m1 = "+document.getElementById("coefDrenaBase").value+" ; a1 = "+document.getElementById("coefBaseGra").value;
			document.getElementById("recibecoefBaseVida").innerHTML = "Base Granular: m1 = "+document.getElementById("coefDrenaBase").value+" ; a1 = "+document.getElementById("coefBaseGra1").value;

		}else if (selecbase == 2) {
			
			document.getElementById("recibecoefBaseFact").innerHTML = "Base tratada con cemento: m1 = "+document.getElementById("coefDrenaBase").value+" ; a1 = "+document.getElementById("coefBaseCem").value;
			document.getElementById("recibecoefBaseVida").innerHTML = "Base tratada con cemento: m1 = "+document.getElementById("coefDrenaBase").value+" ; a1 = "+document.getElementById("coefBaseCem1").value;
		}
		// SUBBASE COMPARACION
		var espesorSubBase = document.getElementById("espesorSubBase").value;
		var coefEstrucCarpAs = document.getElementById("coefEstrucCarpAs").value;
		...
		document.getElementById("recibemodresefecVida2").innerHTML = "Módulo resiliente efectivo (Mre): "+document.getElementById("totalModResEfectivo").value+" psi";
	  	//Descrip CALCULO SN
	  	document.getElementById("recibedescrSnFut2").innerHTML = "Así mediante la siguiente ecuación se puede obtener matemáticamente el SN futuro y mediante la forma gráfica tal como se muestra en la Figura 5, cuyo valor es "+document.getElementById('totalSN').value;
	  	document.getElementById("recibedescrSnFut3").innerHTML = "Así mediante la siguiente ecuación se puede obtener matemáticamente el SN futuro y mediante la forma gráfica tal como se muestra en la Figura 6, cuyo valor es "+document.getElementById('totalSN').value;
	  	// GRAFICO SN FUTURO
	  	document.getElementById("recibeGrafNomogra1").src = dataURL3;
	  	// GRAFICO SN FUTURO
	  	document.getElementById("recibeGrafNomogra2").src = dataURL3;
	...
	//FIN DATOS
		...
		document.getElementById("recibersEspDNDT").innerHTML = "Espesor de nueva carpeta (D)= "+document.getElementById("espFinalNDT").value;
		//METODO Factor
		...
		document.getElementById("recibersEspDFactor").innerHTML = "Espesor de nueva carpeta (D)= "+document.getElementById("espFinalFactor").value;
		//METODO Vida
		...
		document.getElementById("recibersEspDVida").innerHTML = "Espesor de nueva carpeta (D)= "+document.getElementById("espFinalVida").value;
...
//RESULTADOS FINALES
	...
	var newWin=window.open("","Print-Window");
			...
			//newWin.document.write('<html style="font-size: 24px"><head><style type="text/css"> @media print {@page {margin: 20mm 25mm 20mm 25mm;  }   }  </style></head><body style="font-size: 24px" onload="window.print() ">  '+divToPrint.innerHTML+printTabla.innerHTML+'</body></html>');
			newWin.document.write('<style type="text/css">*{font-size: 18px;}{</style>');
