...
function printDiv(){
	  ...
	  var tempCenti = (tempFaren -32)*(5/9); 
...
function printDiv2(){
	...
	//DATOS DEL METODO NDT
	  ...
	  document.getElementById("recibeGrafRelacion").src = dataURL2;
		...
		document.getElementById('recibersEspDNDTRedon').innerHTML = "Espesor sobrecarpeta 'D' redondeado: "+document.getElementById('RedonNdt').value;
		document.getElementById('recibersEspDFactorRedon').innerHTML = "Espesor sobrecarpeta 'D' redondeado: "+document.getElementById('RedonFactor').value;
		document.getElementById('recibersEspDVidaRedon').innerHTML = "Espesor sobrecarpeta 'D' redondeado: "+document.getElementById('RedonVida').value;
		//FIN ESPESOR REDON
		document.getElementById("recibeEsalsFFact2").innerHTML = "Nro. ESAL´s final: "+document.getElementById("nroFinal").value+" ESAL´s, cuyo valor es calculado para el periodo de diseño.";
		document.getElementById("recibezrFact2").innerHTML = "Desviación normal (Zr): "+document.getElementById("zr").value;
		document.getElementById("recibeDesvEstanFact2").innerHTML = "Desviación estándar (So): "+document.getElementById("desviEst").value;
